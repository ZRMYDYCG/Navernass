...
export function NovelTable({
  ...
  return (
    <div className="rounded-lg border border-border overflow-x-auto scrollbar-thin scrollbar-thumb-border hover:scrollbar-thumb-border/80">
          ...
          >
            <TableCell className="py-4 px-2 sm:px-4 text-center">
              <button
                ...
                className="font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-ellipsis overflow-hidden block max-w-[120px] sm:max-w-[200px] mx-auto"
                title={novel.title}
              >
                {novel.title}
              </button>
            ...
            <TableCell className="py-4 px-2 sm:px-4 text-center hidden sm:table-cell">
              <span className="text-sm text-muted-foreground text-ellipsis overflow-hidden block max-w-[200px] mx-auto" title={novel.description || ''}>
                {novel.description || '-'}
              </span>
            </TableCell>
            ...
            <TableCell className="py-4 px-2 sm:px-4 text-center hidden md:table-cell">
