...
export function ChatItemComponent({
  ...
  return (
    <div
      className={cn(
        'flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors',
    ...
    >
      ...
      <div className="flex items-start gap-3 flex-1 min-w-0">
        <MessageCircle className="w-5 h-5 text-gray-700 dark:text-gray-200 mt-0.5 shrink-0" />
