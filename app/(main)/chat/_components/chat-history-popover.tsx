    ...
    <>
      ...
      <div className="p-3 border-b">
        <Button
          ...
          className="w-full flex items-center gap-2 rounded-lg border border-border bg-secondary px-3 py-2 text-sm font-medium text-foreground hover:bg-accent hover:shadow-sm transition-all duration-200 cursor-pointer disabled:text-muted-foreground disabled:border-border/50 disabled:shadow-none disabled:bg-transparent disabled:cursor-not-allowed group"
        >
