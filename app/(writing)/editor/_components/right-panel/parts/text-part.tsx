...
function TextPartInner({ part, role, isStreaming }: TextPartProps) {
  ...
  return (
    <div className="text-foreground break-words break-all [&_.prose]:!text-[11.5px] [&_.prose]:!leading-[1.45] [&_.prose_p]:!my-0.5 [&_.prose_p]:!leading-[1.45] [&_.prose_p]:!text-[11.5px] [&_.prose_hr]:!my-1 [&_.prose_hr]:!border-border/60 [&_.prose_h1]:!text-[14px] [&_.prose_h1]:!my-1 [&_.prose_h2]:!text-[13px] [&_.prose_h2]:!my-1 [&_.prose_h3]:!text-[12px] [&_.prose_h3]:!my-0.5 [&_.prose_ul]:!my-0.5 [&_.prose_ol]:!my-0.5 [&_.prose_li]:!text-[11.5px] [&_.prose_li]:!my-0 [&_.prose_li]:!leading-[1.45] [&_.prose_code]:!text-[10px] [&_.prose_pre]:!my-1 [&_.prose_pre]:!p-1.5 [&_.prose_pre]:!text-[10px] [&_.prose_blockquote]:!my-1 [&_.prose_blockquote]:!pl-3 [&_.prose_table]:!my-1 [&_.prose_th]:!text-[11.5px] [&_.prose_th]:!px-2 [&_.prose_th]:!py-0.5 [&_.prose_td]:!text-[11.5px] [&_.prose_td]:!px-2 [&_.prose_td]:!py-0.5">
      {elements.length > 0 ? elements : <span className="text-foreground"><StreamingMarkdown content={text} isStreaming={isStreaming} /></span>}
      {isStreaming && !text ? <StreamLoading variant="card" /> : null}
      {isStreaming && text ? (
        <span className="inline-block ml-1 align-middle">
          <StreamLoading variant="inline" />
        </span>
      ) : null}
    </div>
  )
