    ...
    <div className="relative flex items-center gap-1">
      ...
      >
        {chapters.map(chapter => (
          <div
            key={chapter.id}
            className="flex items-center gap-1 px-1.5 py-0.5 bg-muted border border-border rounded shrink-0 transition-all duration-200 hover:scale-105 animate-in fade-in-0 slide-in-from-left-1"
          >
            <span
              className="text-[10px] text-foreground truncate max-w-[50px]"
              title={chapter.title}
            >
