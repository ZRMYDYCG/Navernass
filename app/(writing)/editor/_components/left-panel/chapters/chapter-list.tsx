        ...
        >
          ...
          <DragOverlay dropAnimation={null}>
            {activeItem && 'title' in activeItem && 'wordCount' in activeItem
              ? (
                  <div className="bg-card rounded-lg shadow-sm border border-border px-2 py-0.5">
                    <div className="text-[12px] font-normal text-foreground flex items-center gap-1.5">
