                      ...
                      {characters.length === 0
                        ...
                        : (
                            characters.map(character => (
                              <div
                                key={character.id}
                                className="p-3 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                              >
                                <div className="flex items-start justify-between gap-3">
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                      ...
                                      {character.role && (
                                        <span className="px-2 py-0.5 text-[10px] bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300 rounded">
                                          {character.role}
                                        </span>
                                      )}
                                      {character.gender && (
