    ...
    <div className="space-y-1.5">
      ...
      <div className="space-y-1">
        <Button
          ...
          className="w-full justify-start h-7 text-xs bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600"
        >
        ...
        <div className="grid grid-cols-2 gap-1">
          <Button
            ...
            className="h-7 text-xs bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600"
          >
          ...
          <Button
            ...
            disabled={isProcessing || chaptersCount === 0}
            className="h-7 text-xs bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300"
          >
