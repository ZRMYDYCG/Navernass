          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-4 space-y-4">
              ...
              <Button
                ...
                className="w-full bg-black dark:bg-zinc-100 text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-200"
              >
                      ...
                      <button
                        ...
                        className={`px-2 py-2 rounded border transition-all text-sm font-medium ${
                          selectedName === item.name
                            ? 'border-gray-900 dark:border-gray-100 bg-gray-100 dark:bg-zinc-700 text-gray-900 dark:text-gray-100'
