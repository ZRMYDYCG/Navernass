...
export default function EditorContent({
  ...
  const characters = useCharacterMaterialStore(state => state.characterMaterial.characters)
  ...
  const cachedChapter = useChaptersStore(state => (chapterId ? state.chapters.chaptersById[chapterId] : undefined))
  const chaptersStoreHydrated = useChaptersStore(state => state.chapters.hydrated)
  const chapterListedInStore = useChaptersStore(state =>
    chapterId ? state.chapters.chapterIdsOrdered.includes(chapterId) : false,
  )
  const upsertChapterInStore = useChaptersStore(state => state.chaptersActions.upsertChapter)
