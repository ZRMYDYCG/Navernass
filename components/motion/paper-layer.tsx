...
export function PaperLayer({ ref, className, children, texture = true, shadow = 'sm', sheet = true, variants = paperFadeScale, ...props }: PaperLayerProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
  const shadowClass = {
    none: '',
    sm: 'shadow-paper-sm',
    md: 'shadow-paper-md',
