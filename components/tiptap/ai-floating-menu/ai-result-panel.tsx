      ...
      {isLoading && !content && (
        <div>
          <div className="px-2.5 py-2 flex items-center gap-2 border-b border-border">
            ...
            <span className="text-xs text-muted-foreground">{t('tiptap.aiMenu.result.thinking')}</span>
          </div>
        ...
        <div>
          <div className="px-2.5 py-2 flex items-center justify-between border-b border-border">
            <div className="flex items-center gap-2">
              <div className="inline-block w-3 h-3 border-2 border-muted-foreground border-t-foreground animate-spin rounded-full" />
              <span className="text-xs text-muted-foreground">{t('tiptap.aiMenu.result.generating')}</span>
            </div>
            <button
              type="button"
              onClick={onCancel}
              className="p-1 hover:bg-accent rounded transition-colors"
              title={t('tiptap.aiMenu.result.stopGenerating')}
            >
        ...
        <div>
          ...
          <div className="py-0.5">
            ...
            >
              ...
              <span>{t('tiptap.aiMenu.result.applySuggestion')}</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span>{t('tiptap.aiMenu.result.insertBelow')}</span>
            </button>
            <button
              type="button"
              onClick={onCancel}
            ...
            >
              ...
              <span>{t('tiptap.aiMenu.result.retry')}</span>
            </button>
          </div>
        </div>
      )}
