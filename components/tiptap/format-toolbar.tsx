  ...
  return (
    <div className="flex items-center gap-1 p-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
      ...
      <button
        ...
        className={`p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${
          editor.isActive("underline") ? "bg-gray-200 dark:bg-gray-700 text-blue-600 dark:text-blue-400" : "text-gray-700 dark:text-gray-300"
        }`}
        title="下划线"
      >
      ...
      {onAIClick && (
        <>
          ...
          <button
            ...
            className={`p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${
              isAIActive || isAILoading ? "bg-gray-200 dark:bg-gray-700 text-blue-600 dark:text-blue-400" : "text-gray-700 dark:text-gray-300"
            } disabled:opacity-50`}
            title="Ask AI"
          >
            {mounted ? <Sparkles className="w-4 h-4" /> : <div className="w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded animate-pulse" />}
          </button>
        </>
      )}
    </div>
