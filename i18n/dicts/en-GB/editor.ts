const editor = {
  ...
  importChapterDialog: {
    ...
    import: 'Import',
    importAndAnalyze: 'Import & analyse characters',
    analysisHint: 'After import, AI will analyse characters and relationships and build the character graph.',
    phases: {
      import: 'Import',
      analyze: 'AI analysis',
      done: 'Done',
    ...
    analysis: {
      ...
      description: 'Identify characters, analyse relationships, and update the character graph',
      running: 'Agent is analysing step by step…',
      initializing: 'Starting analysis agent…',
      userPrompt: 'Analyse the imported novel text, identify main characters and relationships, and write them to the character graph.',
  ...
  rightPanel: {
    ...
    tools: {
      ...
      proposeEdit: {
        ...
        analyzing: 'Analysing chapter and generating edits…',
        failed: 'Edit failed',
