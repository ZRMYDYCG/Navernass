...
export class LibraryController {
  ...
  async novels(
    ...
    @Query(new ZodPipe(schema.pageQuery)) query: z.infer<typeof schema.pageQuery>,
  ) {
  ...
  createNovel(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.createNovel)) body: schema.CreateNovelInput,
  ) {
  ...
  async archived(@CurrentUser() user: AuthUser) {
    const result = await this.library.listNovels(user.id, {
      page: 1,
      pageSize: 100,
      status: "archived",
    });
  ...
  updateNovel(
    @CurrentUser() user: AuthUser,
    @Param(new ZodPipe(schema.idParams)) params: { id: string },
    @Body(new ZodPipe(schema.updateNovel)) body: schema.UpdateNovelInput,
  ) {
  ...
  createVolume(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.createVolume)) body: schema.CreateVolumeInput,
  ) {
  ...
  updateVolume(
    @CurrentUser() user: AuthUser,
    @Param(new ZodPipe(schema.idParams)) params: { id: string },
    @Body(new ZodPipe(schema.updateVolume)) body: schema.UpdateVolumeInput,
  ) {
  ...
  createChapter(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.createChapter)) body: schema.CreateChapterInput,
  ) {
  ...
  updateChapter(
    @CurrentUser() user: AuthUser,
    @Param(new ZodPipe(schema.idParams)) params: { id: string },
    @Body(new ZodPipe(schema.updateChapter)) body: schema.UpdateChapterInput,
  ) {
  ...
  searchChapters(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.chapterSearch)) body: z.infer<typeof schema.chapterSearch>,
  ) {
  ...
  createCharacter(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.createCharacter)) body: schema.CreateCharacterInput,
  ) {
  ...
  updateCharacter(
    @CurrentUser() user: AuthUser,
    @Param(new ZodPipe(schema.idParams)) params: { id: string },
    @Body(new ZodPipe(schema.updateCharacter)) body: schema.UpdateCharacterInput,
  ) {
  ...
  createRelationship(
    @CurrentUser() user: AuthUser,
    @Body(new ZodPipe(schema.createRelationship)) body: schema.CreateRelationshipInput,
  ) {
  ...
  updateRelationship(
    @CurrentUser() user: AuthUser,
    @Param(new ZodPipe(schema.idParams)) params: { id: string },
    @Body(new ZodPipe(schema.updateRelationship)) body: schema.UpdateRelationshipInput,
  ) {
