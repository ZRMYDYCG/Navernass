...
export class CreateWorldbookDto extends createZodDto(
  schema.createWorldbook.omit({ novel_id: true }),
) {}
...
export class CreateTimelineDto extends createZodDto(
  schema.createTimeline.omit({ novel_id: true }),
) {}
