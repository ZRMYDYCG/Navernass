...
And then I will say: look at this sunshine—the rainy season will never return.`,
  ...
  aiChatDemo: {
    ...
    description: 'Talk to the Agent in the editor sidebar — continue chapters, polish prose, organise lore, or explore plot directions.',
  },
  agentShowcase: {
    ...
    modes: {
      agent: { name: 'Agent', tagline: 'Continue, polish, edit, and manage your project' },
      ask: { name: 'Ask', tagline: 'Read-only advice — never touches your manuscript' },
      plan: { name: 'Plan', tagline: 'Story arcs and beats saved to plan files' },
      outline: { name: 'Outline', tagline: 'Volume/chapter structure saved to the outline tree' },
      worldbook: { name: 'Worldbook', tagline: 'Lore entries kept consistent in your world bible' },
    },
    sidebar: {
    ...
    highlights: {
      1: { title: 'You approve every edit', description: 'Changes arrive as diffs — accept or reject on your terms. AI as editor, not ghostwriter.' },
      2: { title: 'Memory lives in your project', description: 'Plans, outlines, worldbook, and chapters share one source of truth. Agent reads your lore before writing.' },
      3: { title: 'Continuation with evidence', description: 'Agent mode searches chapters and lore before continuing — fewer continuity breaks and character slips.' },
    },
  },
  albumCollage: {
  ...
  novelManagement: {
    ...
    description: 'Create, organise and edit your novels with chapter management, status tracking and publish controls.',
  },
  themeColorShowcase: {
    title: 'Theme Customisation',
    description: 'Multiple carefully designed colour themes to personalise your writing space.',
    colorThemes: {
      default: 'Default',
      red: 'Red',
      rose: 'Rose',
  ...
  pricing: {
    ...
    badge: 'Recommended',
    previewBadge: 'Paid preview',
    cta: 'Start Now',
    ctaFrozen: 'Coming soon',
    free: {
      name: 'Basic',
      price: 'Free',
    ...
    subscription: {
      ...
      description: 'Advanced tools for power creators. Paid tier in development—preview only.',
      features: {
        1: 'Plugin extensions',
        2: 'Premium model access',
