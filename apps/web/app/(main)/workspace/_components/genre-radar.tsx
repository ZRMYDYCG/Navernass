...
export function GenreRadar({ data, isLoading }: GenreRadarProps) {
  ...
  return (
    <WorkspacePanel
      title={t('workspace.dashboard.genreRadar.title')}
      description={t('workspace.dashboard.genreRadar.description')}
    >
      {isLoading || !data
        ? (
        ...
        : (
            <ChartContainer config={chartConfig} className="mx-auto h-[220px]">
              <RadarChart data={data}>
                ...
                <Radar dataKey="published" fill="var(--chart-1)" fillOpacity={0.2} stroke="var(--chart-1)" strokeWidth={1.5} />
                <Radar dataKey="draft" fill="var(--chart-3)" fillOpacity={0.12} stroke="var(--chart-3)" strokeWidth={1.5} />
                <Radar dataKey="archived" fill="var(--chart-2)" fillOpacity={0.12} stroke="var(--chart-2)" strokeWidth={1.5} />
