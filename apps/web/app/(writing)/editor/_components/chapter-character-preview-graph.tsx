...
import { getCharacterColor, useCharacterMaterialStore, useCharacterGraphStore } from '@/store'
...
export function ChapterCharacterPreviewGraph({
  ...
  const relationshipsByNovel = useCharacterGraphStore(state => state.characterGraph.relationshipsByNovel)
