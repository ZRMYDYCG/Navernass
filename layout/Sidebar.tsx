...
export function Sidebar() {
  ...
  return (
    <Tooltip.Provider delayDuration={300}>
      <aside className="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-40">
        {/* 切换按钮 - 始终可见 */}
        ...
        {/* macOS Dock 风格侧边栏 */}
        <div
          className={`mb-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-2xl shadow-2xl px-3 py-2 transition-all duration-300 ease-in-out ${
            isVisible
